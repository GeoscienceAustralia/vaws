...
class TestScenario8(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        cfg.db_file = os.path.join(path, 'test_scenario8.db')
        cls.house_damage = HouseDamage(cfg, seed=0)
...
class TestScenario9(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        cfg.db_file = os.path.join(path, 'test_scenario9.db')
        cls.house_damage = HouseDamage(cfg, seed=0)
...
class TestScenario10(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        cfg.db_file = os.path.join(path, 'test_scenario10.db')
        cls.house_damage = HouseDamage(cfg, seed=0)
...
class TestScenario11(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        cfg.db_file = os.path.join(path, 'test_scenario11.db')
        cls.house_damage = HouseDamage(cfg, seed=0)
...
class TestScenario12(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        cfg.db_file = os.path.join(path, 'test_scenario12.db')
        cls.house_damage = HouseDamage(cfg, seed=0)
...
class TestScenario13(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        cfg.db_file = os.path.join(path, 'test_scenario13.db')
        cls.house_damage = HouseDamage(cfg, seed=0)
...
class TestScenario14(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        cfg.db_file = os.path.join(path, 'test_scenario14.db')
        cls.house_damage = HouseDamage(cfg, seed=0)
